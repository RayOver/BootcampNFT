...
const CONTRACT_ADDRESS = "0xd118A4B27e598B0c7C87d9778070A497e26B985f"
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">Coleção UFO de NFT</p>
          <p className="sub-text">Nunca vistos</p>
          {currentAccount === "" ? (
