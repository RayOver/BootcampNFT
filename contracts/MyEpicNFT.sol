...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["VIALACTEA", "ANDROMEDA", "SOMBRERO", "WHIRLPOOL", "CARTWHEEL", "BLACKEYE"];
    string[] secondWords = ["SOL", "ALDEBARA", "POLARIS", "ANTARES", "BELLATRIX", "RIGEL"];
    string[] thirdWords = ["MERCURIO", "VENUS", "MARTE", "JUPITER", "SATURNO", "NETUNO"];
    event NewEpicNFTMinted(address sender, uint256 tokenId);


    // Nós precisamos passar o nome do nosso token NFT e o símbolo dele.
    constructor() ERC721 ("UFO NFT", "UFO"){
      console.log("Esse eh meu contrato de NFT! dinamico");
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        combinedWord,
                        '", "description": "A colecao nunca vista.", "image": "data:image/svg+xml;base64,',
